        ...
        <div className="container grid grid-cols-1 gap-4">
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 py-3">
              ...
              <div>
                <label htmlFor="destination" className="opacity-70 block text-white">
            ...
            <button className="bg-gradient-to-r from-primary to-secondary text-white hover:scale-105 px-4 py-2 rounded-full duration-200 absolute -bottom-5 left-1/2 -translate-x-1/2 shadow-blue-500/50">
              Search Now
            </button>
          </div>
        </div>
