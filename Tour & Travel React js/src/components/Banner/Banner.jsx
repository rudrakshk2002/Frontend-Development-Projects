          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0 lg:px-16">
                ...
                >
                Let TravellGo be your guide to discovering the world's most incredible places. Our passionate team of travel experts is here to turn your travel dreams into reality. Ready to explore? Start planning your next adventure with us now!
                  <br />
                </p>
